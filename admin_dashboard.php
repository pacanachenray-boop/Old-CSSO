...
.menu li.has-submenu.open .submenu-arrow {
...
<div class="sidebar" id="sidebar">
  ...
  <ul class="menu">
    ...
    <li data-title="Fines" onclick="navigate('fines.php', this)">
      <i class="fa fa-gavel"></i><span>Fines Payments</span>
    </li>
    
    <!-- 7. Payments List -->
    <li data-title="Payments" onclick="navigate('payments.php', this)">
      <i class="fa fa-wallet"></i><span>Payments List</span>
    </li>
    ...
    <!-- 10. Reports - Now opens directly in full screen -->
    <li data-title="Reports" onclick="openReportsFullScreen(this)">
...
// Open Reports in Full Screen (same window, no sidebar)
function openReportsFullScreen(element) {
  // Remove active class from all menu items
  document.querySelectorAll('.menu li').forEach(li => li.classList.remove('active'));
  
  // Add active class to Reports menu item
  element.classList.add('active');
  
  // Navigate to reports page in full screen
