...
// ✅ Check if logged in and allowed user types (Social Manager & Senator only)
...
<title>Member Dashboard | CSSO</title>
...
<div class="sidebar" id="sidebar">
  ...
  <ul class="menu">
    <!-- ✅ EVENTS AND ATTENDANCE ONLY -->
    <li class="active" data-title="Events" onclick="navigate('events.php', this)">
...
<div class="main">
  ...
  <div class="content-container">
    <iframe id="contentFrame" src="events.php"></iframe>
  </div>
</div>
